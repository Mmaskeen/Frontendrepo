<x-guest-layout>
    <x-auth-card>
        ...
        <x-slot name="pagetitle">
            ...
            <h2 style="font-family: Nunito; font-size: 30px; font-weight: 900; line-height: 52.5px; letter-spacing: 2px; text-align: center;  color: #3D6670; display: inline-block; padding: 0 10px;">
                SIGN IN
            </h2>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="grid gap-6">
                ...
                <div>
                    <x-button style="background: #404CB2;" class="custom-button justify-center w-full gap-2">
